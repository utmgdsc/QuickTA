...
const StudentPage = ({currCourse, setCurrCourse, semester, courses, isLoading, UTORid,
  ...
  const setModel = async (model_num) => {
    ...
    setCurrCourse({course_id: courses[parseInt(sessionStorage.getItem("selected"))].course_id,
      course_code: courses[parseInt(sessionStorage.getItem("selected"))].course_code,
      semester: courses[parseInt(sessionStorage.getItem("selected"))].semester,
      course_name: courses[parseInt(sessionStorage.getItem("selected"))].course_name});
