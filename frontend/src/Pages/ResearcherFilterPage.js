...
export class ResearcherFilterPage extends Component {
  ...
  FilterFn() {
    ...
    var filteredData = this.state.chatWithoutFilter.filter(function (el) {
      return (
        el.conversation_id
          .toString()
          .toLowerCase()
          .includes(conversation_idFilter.toString().trim().toLowerCase()) &&
        el.course_id
          .toString()
          .toLowerCase()
          .includes(course_idFilter.toString().trim().toLowerCase()) &&
        el.user_id
          .toString()
          .toLowerCase()
          .includes(user_idFilter.toString().trim().toLowerCase()) &&
        el.starttime
          .toString()
          .toLowerCase()
          .includes(starttimeFilter.toString().trim().toLowerCase()) &&
        el.endtime
          .toString()
          .toLowerCase()
          .includes(endtimeFilter.toString().trim().toLowerCase()) &&
        el.status
          .toString()
          .toLowerCase()
          .includes(statusFilter.toString().trim().toLowerCase()) &&
        el.report
          .toString()
          .toLowerCase()
          .includes(reportFilter.toString().trim().toLowerCase()) &&
        el.rating
          .toString()
          .toLowerCase()
          .includes(ratingFilter.toString().trim().toLowerCase()) &&
        el.feedback_msg
          .toString()
          .toLowerCase()
          .includes(feedback_msgFilter.toString().trim().toLowerCase())
      );
    });
  ...
  render() {
    ...
    return (
      <div>
        {/* <TopNav UTORid={this.props.UTORid} auth={auth} /> */}
              ...
              <Tr>
                <Th>
                  <div>
                    <Input
                      name="id_contains"
                      onChange={this.changeConversationIdFilter}
                      placeholder="Filter"
                    />
                    <Button
                      onClick={() => this.sortResult("conversation_id", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("conversation_id", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    ...
                    />
                    <Button
                      onClick={() => this.sortResult("course_id", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("course_id", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    ...
                    />
                    <Button
                      onClick={() => this.sortResult("user_id", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("user_id", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    <Input
                      onChange={this.changeStartTimeFilter}
                      placeholder="Filter"
                    />
                    <Button
                      onClick={() => this.sortResult("start_time", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("start_time", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    <Input
                      onChange={this.changeEndTimeFilter}
                      placeholder="Filter"
                    />

                    <Button
                      onClick={() => this.sortResult("end_time", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("end_time", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    ...
                    />
                    <Button
                      onClick={() => this.sortResult("report", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("report", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    ...
                    />
                    <Button
                      onClick={() => this.sortResult("rating", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("rating", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
                ...
                <Th>
                  <div>
                    <Input
                      onChange={this.changeFeedbackMsgFilter}
                      placeholder="Filter"
                    />
                    <Button
                      onClick={() => this.sortResult("feedback_msg", true)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronUpIcon />
                    ...
                    <Button
                      onClick={() => this.sortResult("feedback_msg", false)}
                      colorScheme="blue"
                      size="sm"
                    >
                      <ChevronDownIcon />
